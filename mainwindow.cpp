...
void MainWindow::on_pb_recher_clicked()
{
    ...
    if(ui->rech->currentText()=="ID de Programme")
       ui->tableau->setModel( m.recherche(2,s));
    if(ui->rech->currentText()=="Nom du Diffuseur")
...
void MainWindow::on_pb_tri_clicked()
{
    ...
    if(ui->tri->currentText()=="ID de Programme")
       ui->tableau->setModel( m.sort(2));
    if(ui->tri->currentText()=="Nom du Diffuseur")
