...
{
    ui->le_matri->setText(ui->tabsponsor->model()->data(ui->tabsponsor->model()->index(index.row(),1)).toString());
    ui->le_nom->setText(ui->tabsponsor->model()->data(ui->tabsponsor->model()->index(index.row(),0)).toString());
